...
class VideoStarter:
    ...
    def __init__(self, stream_address: str, stream_port: str, mux: Mux, keypoint_feedback: KeypointResponder, file: str, connection_offers: dict, connection_answers: dict):
    ...
    async def start(self):
        ...
        self.streamer = await self.mux.create_single_stream(offer, self.keypoint_feedback, self.connection_offers, self.connection_answers, **kwargs)
